...
// // 		`${URL}/dashboard/ArticlesByType/برنامج السفراء`,
// // 		{
// // 		  method: "GET",
// // 		  headers: {
...
//     const res = await fetch(
//       `${URL}/dashboard/articles/AllByCTG?page=1&limit=10&ctg=7`,
//       {
//         method: "GET",
//         headers: {
//           "Content-Type": "application/json",
...
// 						}}
// 					>
// 						{highlightText(t("Ambassadors.title"), searchTerm)}
// 					</div>
// 				</div>
