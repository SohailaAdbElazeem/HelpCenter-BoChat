  ...
  return (
    ...
    >
      <div className="w-100" style={{ maxWidth: "1100px", margin: "0 auto" }}>
        ...
        <div className="mb-5">
          <div
            ...
            style={{
              ...
              color: "#000000",
              maxWidth: "800px",
              fontSize: "clamp(20px, 8vw, 50px)",
              lineHeight: "clamp(20px, 6vw, 45px)",
              margin: "clamp(10px, 10vw, 90px) 0 clamp(10px, 8vw, 60px) 0",
            //   textAlign: isLTR ? "left" : "right",
              direction: isLTR ? "ltr" : "rtl",
            }}
        ...
        <div className={`questions-section ${isLTR ? "ltr" : "rtl"}`}>
              ...
              filteredQuestions.map((item, index) => (
                ...
                >
                  <div className="question">
                    <img src={activeIndex === index ? close : plus} alt="toggle" />
