...
// // 		`${URL}/dashboard/ArticlesByType/الدفع والاشتراكات`,
// // 		{
// // 		  method: "GET",
// // 		  headers: {
...
//     const res = await fetch(
//       `${URL}/dashboard/articles/AllByCTG?page=1&limit=10&ctg=6`,
//       {
//         method: "GET",
//         headers: {
//           "Content-Type": "application/json",
        ...
        {filteredArticles.length > 0 ? (
          ...
          >
            <p style={{ fontSize: "18px", color: "#666", marginBottom: "20px" }}>
              {t("subscriptions.noResults", { searchTerm }) || t("security.noResults", { searchTerm })}
            </p>
          </div>
        )}
      </div>
